 ...
 */
exports.route.get('/report/:uuid', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
	var uuid;
	return __generator(this, function (_a) {
		uuid = parseInt(req.params.uuid, 10);
		try {
			...
			// }
			if (uuid) {
				return [2 /*return*/, res.status(200).send('' + uuid)];
			}
...
exports.route.post('/extract/data/csv', upload_1.uploadCSV);
