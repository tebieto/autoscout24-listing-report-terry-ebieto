...
var contact_1 = __importDefault(require("./db/models/contact"));
var listing_1 = __importDefault(require("./db/models/listing"));
var report_1 = __importDefault(require("./db/models/report"));
    ...
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, report_1.default.sync({ force: true })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, contact_1.default.sync({ force: true })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, listing_1.default.sync({ force: true })];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
